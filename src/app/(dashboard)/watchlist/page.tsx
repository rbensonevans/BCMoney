    ...
    return (
      <div className="shrink-0" style={{ width: size, height: size }}>
        <svg viewBox="0 0 32 32" width={size} height={size} fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M17.8 17.5C17.8 19.1 16.5 20.1 14.9 20.3V21.4H13.8V20.3C12.3 20.2 11.3 19.3 11.2 18H12.6C12.7 18.6 13.3 19.1 14.4 19.2V17.3L13.1 17C11.9 16.7 11.1 16 11.1 14.8C11.1 13.4 12.2 12.5 13.7 12.3V11.2H14.8V12.3C16.2 12.4 17 13.1 17.1 14.2H15.7C15.6 13.6 15.1 13.1 14.2 13.1V14.9L15.5 15.2C16.8 15.5 17.8 16.3 17.8 17.5ZM14.9 18C15.9 17.9 16.5 17.5 16.5 16.8C16.5 16.3 16.2 15.9 15.4 15.7L14.4 15.5V17.9C14.4 17.9 14.6 18 14.9 18ZM14.9 18C15.9 17.9 16.5 17.5 16.5 16.8C16.5 16.3 16.2 15.9 15.4 15.7L14.4 15.5V17.9C14.4 17.9 14.6 18 14.9 18ZM13.1 14.4C12.3 14.5 12.3 14.9 12.3 15.2C12.3 15.6 12.6 15.9 13.3 16.1L13.8 16.2V14.3C13.8 14.3 13.4 14.3 13.1 14.4Z" fill="white"/>
        </svg>
      </div>
    )
  }
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-muted/50">
                  ...
                  <TableHead className="text-right w-[80px]">On / Off</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
